...
namespace SSharedExperience
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings SharedExperience = new SAssemblies.Menu.MenuItemSettings();
    ...
    internal class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SSharedExperience loaded!", System.Drawing.Color.LawnGreen, 5000);
        }
    }
}
