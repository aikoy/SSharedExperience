...
namespace SGankD
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings Gank = new SAssemblies.Menu.MenuItemSettings();
    ...
    internal class Program
    {
        ...
        private void CreateMenu()
        {
            try
            {
                ...
                mainMenu.UpdateDirEntry(ref MainMenu.Gank, Gank.SetupMenu(MainMenu.Detector.Menu));
