...
namespace SAntiVisualScreenStealth
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings AntiVisualScreenStealth = new SAssemblies.Menu.MenuItemSettings();
    ...
    internal class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SAntiVisualScreenStealth loaded!", Color.LawnGreen, 5000);
        }
    }
}
