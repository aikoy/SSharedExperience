...
namespace SAutoLevler
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings AutoLevler = new SAssemblies.Menu.MenuItemSettings();
    ...
    internal class Program
    {
        ...
        private void CreateMenu()
        {
            try
            {
                ...
                mainMenu.UpdateDirEntry(ref MainMenu.AutoLevler, AutoLevler.SetupMenu(MainMenu.Misc.Menu));
        ...
        {
            CreateMenu();
            Common.ShowNotification("SAutoLevler loaded!", Color.LawnGreen, 5000);
        }
    }
}
