...
namespace SSkinChanger
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings SkinChanger = new SAssemblies.Menu.MenuItemSettings();
    ...
    internal class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SSkinChanger loaded!", Color.LawnGreen, 5000);
        }
    }
}
