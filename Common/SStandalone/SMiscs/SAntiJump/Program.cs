...
namespace SAntiJump
{
    ...
    internal class MainMenu : SAssemblies.Menu
    {
        ...
        public static SAssemblies.Menu.MenuItemSettings AntiJump = new SAssemblies.Menu.MenuItemSettings();

        public MainMenu()
        {
            MenuEntries = new Dictionary<SAssemblies.Menu.MenuItemSettings, Func<dynamic>>
                              {
                                  { AntiJump, () => new AntiJump() },
                              };
        }
    ...
    internal class Program
    {
        ...
        {
            CreateMenu();
            Common.ShowNotification("SAntiJump loaded!", Color.LawnGreen, 5000);
        }
    }
}
